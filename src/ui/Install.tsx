...
const DISMISS_KEY = "cf-install-dismissed";
      ...
      {open && (
        <div className="overlay" onClick={() => setOpen(false)}>
          <div
            ...
            role="dialog"
            aria-modal="true"
            aria-label="Install cyber-fit"
            onClick={(e) => e.stopPropagation()}
          >
            <h2>Install cyber-fit</h2>
            <p>
              Add it to your home screen for a full-screen experience that runs with zero signal.
              (On iOS this is also required if you ever want reminder notifications.)
            </p>
            ...
            {deferred ? (
              ...
              <ol className="install-steps">
                ...
                <li>
                  Tap <strong>Add</strong>, then open cyber-fit from your home screen.
                </li>
              </ol>
            ) : (
              <ol className="install-steps">
