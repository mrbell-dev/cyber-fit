// Bundled offline exercise vocabulary for autocomplete — no accounts, no API
// keys, no network. Curated common movements first, then the full
// free-exercise-db catalog (github.com/yuhonas/free-exercise-db, public
// domain / Unlicense — 850 additional movements).

export const EXERCISES: string[] = [
  // curated (incl. cardio + mobility the DB lacks)
  "Squat",
  "Front squat",
  "Goblet squat",
  "Deadlift",
